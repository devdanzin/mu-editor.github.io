...
<div class="row">
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="/en/tutorials/1.0{{ slash_index }}">
      ...
      <div class="caption">
        ...
        this!</strong></p>
        <p><a href="/en/tutorials/1.0{{ slash_index }}" class="btn btn-primary"
  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="/en/howto/1.0{{ slash_index }}">
      ...
      <div class="caption">
        ...
        look here.</p>
        <p><a href="/en/howto/1.0{{ slash_index }}" class="btn btn-primary"

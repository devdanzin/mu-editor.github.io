...
<div class="row">
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="{{ base }}/en/tutorials/1.1{{ site._slash_index }}">
      ...
      <div class="caption">
        ...
        this!</strong></p>
        <p><a href="{{ base }}/en/tutorials/1.1{{ site._slash_index }}" class="btn btn-primary"
  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="{{ base }}/en/howto/1.1{{ site._slash_index }}">
      ...
      <div class="caption">
        ...
        look here.</p>
        <p><a href="{{ base }}/en/howto/1.1{{ site._slash_index }}" class="btn btn-primary"
  ...
  <div class="col-sm-4 col-md-4">
    <div class="thumbnail">
      <a href="{{ base }}/en/discuss{{ site._html }}">
      ...
      <div class="caption">
        ...
        <p><a href="{{ base }}/en/discuss{{ site._html }}" class="btn btn-primary"
